#
#  Be sure to run `pod spec lint waterflowView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jimckylin"
  # s.authors            = { "jimckylin" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/jimckylin"
